        ...
        $stateProvider
            .state('workspace.petals', {
                ...
                views: {
                    ...
                    'nav-console': {
                        template: '<h1>THIS IS NAV PETALS</h1>',
                        controller: '',
                        onEnter: function () {
                    ...
                    'console': {
                        template: '<h1>THIS IS CONSOLE PETALS</h1>',
                        controller: '',
                        onEnter: function () {
            ...
            .state('workspace.petals.bus', {
                ...
                views: {
                    'petals@busNavConsole': {
                        ...
                        templateUrl: 'src/client/app/petals-component/bus/bus-nav-console/bus-nav-console.html',
                        onEnter: function () {
            ...
            .state('workspace.petals.server', {
                ...
                views: {
                    'petals@serverNavConsole': {
                        ...
                        templateUrl: 'src/client/app/petals-component/server/server-nav-console/server-nav-console.html',
                        onEnter: function () {
